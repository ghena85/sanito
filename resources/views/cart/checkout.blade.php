            ...
            <div class="checkout-grid">
                <div class="checkout-grid__main checkout-main">
                    <div class="checkout-main__block billing">
                        ...
                        <div class="billing-form">
                            ...
                            <label for="name">
                                First name
                                <input type="text" placeholder="First Name" required name="first_name" id="name">
                            </label>
                            <label for="surname">
                                Last name
                                <input type="text" placeholder="Last Name" required name="last_name" id="surname">
                            </label>
                            <label for="email">
                                E-mail
                                <input type="email" placeholder="example@mail.com" required name="email" id="email">
                            </label>
                            <label for="phone">
                                Phone number
                                <input type="tel" value="(+373)"  requiredplaceholder="(+373)  XX - XX - XX - XX" name="phone" id="phone">
                            </label>
                            <label for="city">
                                City/Province
                                <div class="select">
                            ...
                            <label for="address">
                                Full adress
                                <input type="text" required placeholder="Enter shipping adress" name="address" id="address">
                            </label>
                        </div>
                    </div>
                ...
                <div class="checkout-grid__information">
                    <aside class="checkout-grid__sidebar">
                        ...
                        <button type="submit" class="accent-btn order">{{ $vars['place_my_order'] }}</button>
                    </aside>
