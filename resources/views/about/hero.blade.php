<div class="container">
    <div class="breadcrumb">
        <ul class="breadcrumb-list ">
            ...
            <li class="breadcrumb-list__item">
                <a href="#" class="breadcrumb-list__link">About us</a>
            </li>
        </ul>
    </div>
    ...
    <div class="about-card">
        ...
        <div class="about-card__item">
            ...
            <h4 class="footer-title">Best quality</h4>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
        </div>
    ...
    <div class="about-director">
        ...
        <div class="about-director__descr">
            ...
            <h5 class="about-director__name">James Franco</h5>
            <span class="about-director__position">Director General</span>
            <p >
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor
